...
func defaultSSHConfig() *SSHConfig {
	return NewSSHConfig("chuacw", "/Users/chuacw/Downloads/nodes/localhost", "localhost")
}
...
func TestSshConfig_Interrupt(t *testing.T) {
	...
	if !sshConfig.ProcessStatus("geth").Exists {
		...
		case "darwin":
			{
				cmd = exec.Command("/Users/chuacw/Downloads/nodes/geth", "--syncmode fast")
			}
		case "linux":
			{
...
func TestSSHConfig_Close(t *testing.T) {
	sshConfig := NewSSHConfig("ubuntu", "/Users/chuacw/.ssh/quorum", "ec2-52-201-244-132.compute-1.amazonaws.com")
...
func TestSSHConfig_CopyLocalFileToRemotePath(t *testing.T) {
	sshConfig := NewSSHConfig("ubuntu", "/Users/chuacw/.ssh/quorum", "ec2-52-201-244-132.compute-1.amazonaws.com")
	sshConfig.CopyLocalFileToRemoteFile("/Users/chuacw/Documents/GitHub/SoftwareUpgrade/src/SoftwareUpgrade/sshSession_test.go",
		"/tmp/sshSession_test.go", "0644")
	sshConfig.CopyLocalFileToRemoteFile("/Users/chuacw/Documents/GitHub/SoftwareUpgrade/src/SoftwareUpgrade/sshSession.go",
